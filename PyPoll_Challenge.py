...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        #4a:  Write an if statment that checks that the
...
with open(file_to_save, "w") as txt_file:
    ...
    #7: Print the county with the largest to the terminal.
    largest_county_voter_turnout = (
        f"-----------------------\n"
        f"Largest County Turnout: {largest_county}\n"
        f"---------------------\n\n")
    print(largest_county_voter_turnout, end="")
    ...
    # Print the winning candidate's (to terminal)
